...
def eval_tasks(model, tasks, current_task, args):
    ...
    for i, task in enumerate(tasks):
        # print("in for loop this many times: i,task")
        # print(i,task)
        t = i
        x = task[1]
        y = task[2]
        ...
        if i == 0:
            ...
            # print(current_task)
            # print("accuracy on task 1 of the 5 is")
            # print(rt / x.size(0))
        else:
            print("")
            #print("curent i is not 0")
        ...
        if t == current_task:
            ...
            #print(" in t==current_task")
            ac1 = task1acc/total_size
            #print(ac1)
    

    if current_task == 0:
        print("")
        # print("out of the for loop, current task is 0")
        # print(total_pred/total_size)
...
def life_experience(model, continuum, x_te, args):
    ...
    current_avg_acc_list={0:0,1:0,2:0,3:0,4:0}#avg accuracy on task seen so far
    current_task = 0
    time_start = time.time()
    # print(" continuum")
    # print(continuum)
    #print("len of continuum")
