...
pathminiImageNet = '/media/data/morgan_data/mini_imagenet' #'/home/mengmi/Projects/Proj_CL/mini_imagenet/mini_imagenet/'
...
class Mini_imagenet(data.Dataset):
    ...
    def sample_train_val(self, sample_ratio=0.2):
        ...
        f = open('/media/data/morgan_data/mini_imagenet/sampled_miniimagenet_val.pt', "wb")
        pickle.dump(sampled_miniimagenet_val, f, protocol=2)
        f.close()

        f = open('/media/data/morgan_data/mini_imagenet/sampled_miniimagenet_train.pt', "wb")
    ...
    def load_sampled_set(self, split):
        ...
        if split == 'train':
            f = open('/media/data/morgan_data/mini_imagenet/sampled_miniimagenet_train.pt', "rb")
            ...
            f = open('/media/data/morgan_data/mini_imagenet/sampled_miniimagenet_val.pt', "rb")
