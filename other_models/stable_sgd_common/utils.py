...
def parse_arguments():
	...
	parser.add_argument('--dataset', default='cifar100', type=str, help='dataset. options: core50, toybox, ilab')
...
def log_metrics(metrics, time, task_id, acc_db, loss_db):
	...
	#if task_id >= 1 and task_id <= 20:
	#	task_acc.append(metrics['accuracy'])
