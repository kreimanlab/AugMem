...
#python -u experiment.py --scenario iid --dataset $DATASET --dataroot $DATAROOT                 --n_runs 10 --model_type resnet --model_name ResNet18 --pretrained --agent_type regularization --agent_name SI  --gpuid $GPU --lr 0.0001 --momentum 0.9 --weight_decay 0.0001 --batch_size 21 --n_workers 20 --reg_coef 0.01 | tee ${OUTDIR}/iid/SI_ResNet18/log.log                 &
python -u experiment.py --scenario class_iid --dataset $DATASET --dataroot $DATAROOT           --n_runs 10 --model_type resnet --model_name ResNet18 --pretrained --agent_type regularization --agent_name SI  --gpuid $GPU --lr 0.0001 --momentum 0.9 --weight_decay 0.0001 --batch_size 21 --n_workers 20 --reg_coef 0.01 | tee ${OUTDIR}/class_iid/SI_ResNet18/log.log           &
#python -u experiment.py --scenario instance --dataset $DATASET --dataroot $DATAROOT            --n_runs 10 --model_type resnet --model_name ResNet18 --pretrained --agent_type regularization --agent_name SI  --gpuid $GPU --lr 0.0001 --momentum 0.9 --weight_decay 0.0001 --batch_size 21 --n_workers 20 --reg_coef 0.01 | tee ${OUTDIR}/instance/SI_ResNet18/log.log            &
python -u experiment.py --scenario class_instance --dataset $DATASET --dataroot $DATAROOT      --n_runs 10 --model_type resnet --model_name ResNet18 --pretrained --agent_type regularization --agent_name SI  --gpuid $GPU --lr 0.0001 --momentum 0.9 --weight_decay 0.0001 --batch_size 21 --n_workers 20 --reg_coef 0.01 | tee ${OUTDIR}/class_instance/SI_ResNet18/log.log
