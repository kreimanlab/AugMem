...
%resultrootdir = '/home/mengmi/Projects/Proj_CL_NTM/pytorch/finalResults_March17/ilab2mlight_outputs/';
resultrootdir = '/home/mengmi/Desktop/aaai/aaai_results/finalResults_March17/ilab2mlight_outputs/';
...
%                 testresult = readtable([resultrootdir typecase '/' model '_gridsearch/' testresult '/test.csv']);
            ...
            testresult = readtable(['/home/mengmi/Desktop/aaai/Rushikesh_results/' model '_ilab_' temptypecase '.csv']);    
...
%             end
    ...
    %else
        ...
        set(hb,'Position',[680   462   788   500]);
    %end
    legend boxoff 
    ...
    print(hb,['Figure/performance_' typecase '_ilab' printpostfix],printmode,printoption);
...
pos = get(hb,'Position');
set(hb,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(hb,['Figure/fig_ilab_avg_accu' printpostfix],printmode,printoption);
