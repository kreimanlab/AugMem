...
%resultrootdir = '/home/mengmi/Desktop/toybox_outputs/';
resultrootdir = '/home/mengmi/Desktop/aaai/aaai_results/firstResults_March23/toybox_outputs/';
...
legendname={'HAMN (ours)','EWC','GEM','iCARL','L2','MAS','NaiveRehearsal','SI','Stable','GSS','BIC','CoPE','LwF','lowerBound','upperBound','Chance'};
...
%                 testresult = readtable([resultrootdir typecase '/' model '_gridsearch/' testresult '/test.csv']);
            ...
            testresult = readtable(['/home/mengmi/Desktop/aaai/Rushikesh_results_1stAccu/' model '/1stTask_' model '_toybox_' temptypecase '.csv']);    
...
%             end
    ...
    print(hb,['Figure/performance_' typecase '_toybox_1sttask' printpostfix],printmode,printoption);
...
pos = get(hb,'Position');
set(hb,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(hb,['Figure/fig_toybox_1stTask_accu' printpostfix],printmode,printoption);
