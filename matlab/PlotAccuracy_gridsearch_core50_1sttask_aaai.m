...
resultrootdir = '/home/mengmi/Desktop/aaai/aaai_results/firstResults_March23/core50_outputs/';
%resultrootdir = '/home/mengmi/Desktop/aaai/Rushikesh_results_1stAccu/';
%resultrootdir = '/home/mengmi/Desktop/core50_outputs/';
...
%                 testresult = readtable([resultrootdir typecase '/' model '_gridsearch/' testresult '/test.csv']);
            ...
            testresult = readtable(['/home/mengmi/Desktop/aaai/Rushikesh_results_1stAccu/' model '/1stTask_' model '_core50_' temptypecase '.csv']);    
...
%             end
    ...
    print(hb,['Figure/performance_' typecase '_core50_1sttask' printpostfix],printmode,printoption);
...
pos = get(hb,'Position');
set(hb,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(hb,['Figure/fig_core50_1stTask_accu' printpostfix],printmode,printoption);
