...
custom_folder="AugMem_lr_${lr}_memsparse_${mem_sparse}_memNslots_${memory_Nslots}_memNfeat_${memory_Nfeat}_memsize_${memory_size}_noT1replay_25T1epochs_10runs_512feat"
