...
python -u experiment.py --scenario class_iid --dataset $DATASET --dataroot $DATAROOT  --lr 0.00001 --reg_coef 1 --n_epoch_first_task 25 --n_runs 1 --model_type resnet --model_name ResNet18 --pretrained --agent_type regularization --agent_name SI  --gpuid $GPU --momentum 0.9 --weight_decay 0.0001 --batch_size 21 --n_workers 8 --output_dir $OUTDIR | tee ${OUTDIR}/class_iid/SI_ResNet18/log.log
python -u plot.py --n_class_per_task 10 --scenario class_iid --output_dir $OUTDIR --result_dir SI_ResNet18
