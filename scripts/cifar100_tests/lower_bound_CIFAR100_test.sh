...
python -u experiment.py --scenario class_iid --dataset $DATASET --dataroot $DATAROOT  --lr 0.001 --n_epoch_first_task 10  --n_epoch 10 --n_runs 1 --model_type resnet --model_name ResNet18 --pretrained --agent_type default --agent_name NormalNN  --gpuid $GPU --momentum 0.9 --weight_decay 0.0001 --batch_size 21 --n_workers 8 | tee ${OUTDIR}/class_iid/NormalNN_ResNet18/log.log
