...
python -u experiment_aug.py --scenario class_iid --replay_coef 0 --output_dir outputs_NoReplay  --first_times 1 --replay_times 0 --reg_coef 1000 --n_epoch 1  --memory_size 200 --freeze_feature_extract --n_runs 5 --model_type resnet --model_name ResNet18 --pretrained --memory_Nslots 100  --memory_Nfeat 8 --agent_type aug_mem --agent_name AugMem  --gpuid 2 --momentum 0.9 --weight_decay 0.0001 --batch_size 21 --n_workers 20 | tee ${OUTDIR}/class_iid/AugMem_ResNet18/log.log    #&            
#--freeze_feature_extract

python -u experiment_aug.py --freeze_feature_extract --lr 0.00001 --first_times 3 --output_dir outputs_NoReplay --replay_coef 0 --replay_times 0 --memory_size 200 --scenario class_instance --reg_coef 1000 --n_epoch 1 --n_runs 5 --model_type resnet --model_name ResNet18 --pretrained --memory_Nslots 100  --memory_Nfeat 8 --agent_type aug_mem --agent_name AugMem  --gpuid 2 --momentum 0.9 --weight_decay 0.0001 --batch_size 21 --n_workers 20 | tee ${OUTDIR}/class_instance/AugMem_ResNet18/log.log    #&   
